...
@implementation NSData (ZG_Base64)
...
+ (NSData *)zg_dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = ZG_NewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)zg_base64EncodedString
{
	...
	char *outputBuffer =
		ZG_NewBase64Encode([self bytes], [self length], false, &outputLength);
