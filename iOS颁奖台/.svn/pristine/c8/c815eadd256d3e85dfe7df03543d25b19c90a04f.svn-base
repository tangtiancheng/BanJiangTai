...
@implementation ZGABTestDesignerSnapshotResponseMessage
...
- (void)setScreenshot:(UIImage *)screenshot
{
    ...
    if (screenshot) {
        ...
        if (jpegSnapshotImageData) {
            payloadObject = [jpegSnapshotImageData zg_base64EncodedString];
...
- (UIImage *)screenshot
{
    ...
    NSData *imageData = [NSData zg_dataFromBase64String:base64Image];
