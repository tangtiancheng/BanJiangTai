...
@implementation ZGPropertySelectorParameterDescription
...
@implementation ZGPropertySelectorDescription
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self) {
        ...
        for (NSDictionary *parameter in dictionary[@"parameters"]) {
            [parameters addObject:[[ZGPropertySelectorParameterDescription alloc] initWithDictionary:parameter]];
        }
...
@interface ZGPropertyDescription ()

@property (nonatomic, readonly) NSPredicate *predicate;

@end

@implementation ZGPropertyDescription
...
+ (NSValueTransformer *)valueTransformerForType:(NSString *)typeName
{
    ...
    for (NSString *toTypeName in @[@"NSDictionary", @"NSNumber", @"NSString"]) {
        NSString *toTransformerName = [NSString stringWithFormat:@"ZG%@To%@ValueTransformer", typeName, toTypeName];
    ...
    return [NSValueTransformer valueTransformerForName:@"ZGPassThroughValueTransformer"];
}
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self) {
        ...
        _getSelectorDescription = [[ZGPropertySelectorDescription alloc] initWithDictionary:get];
        if (set) {
            _setSelectorDescription = [[ZGPropertySelectorDescription alloc] initWithDictionary:set];
        } else {
            _readonly = YES;
        }
