...
static NSDictionary *ZGCATransform3DCreateDictionaryRepresentation(CATransform3D transform)
{
    return @{
            @"m11" : @(transform.m11),
            @"m12" : @(transform.m12),
...
static BOOL ZGCATransform3DMakeWithDictionaryRepresentation(NSDictionary *dictionary, CATransform3D *transform)
{
    if (transform) {
...
@implementation ZGCATransform3DToNSDictionaryValueTransformer
...
- (id)transformedValue:(id)value
{
    if ([value respondsToSelector:@selector(CATransform3DValue)]) {
        return ZGCATransform3DCreateDictionaryRepresentation([value CATransform3DValue]);
    }
...
- (id)reverseTransformedValue:(id)value
{
    ...
    if ([value isKindOfClass:[NSDictionary class]] && ZGCATransform3DMakeWithDictionaryRepresentation(value, &transform)) {
