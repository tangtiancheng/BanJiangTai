...
#import "XPDatePicker_DateModel.h"
...
@interface XPDatePicker ()
{
    ...
    //限制model
    XPDatePicker_DateModel *maxDateModel;
    XPDatePicker_DateModel *minDateModel;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.maxLimitDate) {
        maxDateModel = [[XPDatePicker_DateModel alloc]initWithDate:self.maxLimitDate];
    }else{
    ...
    if (self.minLimitDate) {
        minDateModel = [[XPDatePicker_DateModel alloc]initWithDate:self.minLimitDate];
    }else{
...
- (NSArray *)getNowDate:(NSDate *)date
{
    ...
    XPDatePicker_DateModel *model = [[XPDatePicker_DateModel alloc]initWithDate:dateShow];
...
- (void)playTheDelegate
{
    ...
    //代理回调
    [self.delegate XPDatePicker:self
