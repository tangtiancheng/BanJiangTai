//
//  XPAwardReceiveViewController.m
//  XPApp
//
...
#import "XPAwardReceiveViewController.h"
#import "XPAwardViewModel.h"
#import "XPBaseTableViewCell.h"
#import <MJRefresh/MJRefresh.h>
#import <XPKit/XPKit.h>

@interface XPAwardReceiveViewController ()
...
@implementation XPAwardReceiveViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([model.prizeStatus isEqualToString:@"P"]) {
        [(XPBaseViewController *)[self.view belongViewController] pushViewController:[[self instantiateInitialViewControllerWithStoryboardName:@"Web"] tap:^(XPBaseViewController *x) {
