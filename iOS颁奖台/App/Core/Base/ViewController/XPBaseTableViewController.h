...
@interface XPBaseTableViewController (Login)
...
@interface XPBaseTableViewController (Loader)
...
@interface XPBaseTableViewController (Toast)
...
@interface XPBaseTableViewController (RACSignal)
